...
while X == False:
   ...
   if Saisi == "1":
      subprocess.call("clear ; python3 Linux/Chiffrement.py | lolcat", shell=True)
      X = True
   
   elif Saisi == "2":
      subprocess.call("clear ; python3 Linux/Dechiffrement.py | lolcat", shell=True)
      X = True

   elif Saisi == "3":
      subprocess.call("clear ; python3 Linux/Fonctionnement.py | lolcat", shell=True)
      X = True
